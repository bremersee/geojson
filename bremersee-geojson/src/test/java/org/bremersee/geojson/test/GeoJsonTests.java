...
public class GeoJsonTests {
    ...
    private static Point createPoint(double x, double y) {
        CoordinateSequence coordinates = new CoordinateArraySequence(new Coordinate[] { new Coordinate(x, y) });
    ...
    private Polygon createPolygon() {
        return new Polygon(new LinearRing(createLineString().getCoordinateSequence(), getGeometryFactory()), null,
                getGeometryFactory());
    }

    private Polygon createPolygonWithHoles() {
        LineString ls0 = createLineString(new Coordinate[] { new Coordinate(0.1, 0.1), new Coordinate(0.1, 0.2),
                new Coordinate(0.2, 0.2), new Coordinate(0.2, 0.1), new Coordinate(0.1, 0.1) });
        LineString ls1 = createLineString(new Coordinate[] { new Coordinate(0.8, 0.8), new Coordinate(0.8, 0.9),
        ...
        return new Polygon(new LinearRing(createLineString().getCoordinateSequence(), getGeometryFactory()), holes,
                getGeometryFactory());
    }
